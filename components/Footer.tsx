...
const Footer = () => {
  return (
    <div className='w-full border-t border-[#666666] mt-10 grid grid-cols-7 gap-x-20 text-white px-20 py-16'>
        ...
        <input type="text" placeholder='Enter your email' className='bg-[#EEEEEE] h-14 mr-16 rounded-lg text-[#666666] px-3' />
        <input type="text" placeholder='Enter your email' className='bg-[#EEEEEE] h-14 mr-16 rounded-lg text-[#666666] px-3' />
