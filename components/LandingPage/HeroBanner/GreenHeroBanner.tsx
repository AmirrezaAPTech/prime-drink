...
const GreenHeroBanner = () => {
  return (
    <div className='w-full h-screen flex justify-center items-start relative'>
        ...
        <div className='absolute sm:bottom-12 bottom-4 sm:left-12 w-full flex flex-col justify-center sm:items-start items-center gap-y-3'>
            ...
            <button className='xl:text-xl sm:text-md text-sm bg-[#1A1C1B] font-bold text-[#9ED364] sm:px-5 px-3 sm:py-3 py-2  rounded-xl transition-all duration-300 hover:bg-opacity-60 border border-[#9ED364] hover:border-[#1A1C1B] '>DRINK PRIME</button>
        </div>
    </div>
  )
}
